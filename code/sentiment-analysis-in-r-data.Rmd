...
This file contains the data pullfor webinar: [Sentiment Analysis in R](https://www.airweb.org/collaborate-learn/calendar/2021/10/20/event/sentiment-analysis-in-r), presented for the Association for Institutional Research, October 20 & 22 2021.  
...
tweets <- search_tweets(q = "#UArizona OR #ArizonaWildcats", 
                        n = 500,
                        include_rts = FALSE,
                        `-filter` = "replies",
                        lang = "en")
